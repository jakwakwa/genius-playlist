...
export async function POST(
  ...
  try {
    ...
    if (!generated || generated.userId !== userId) {
      return new Response(
        JSON.stringify({ error: "Generated playlist not found" }),
        {
          status: 404,
          headers: { "Content-Type": "application/json" },
        }
    ...
    if (!meRes.ok) {
      return new Response(
        JSON.stringify({ error: "Failed to fetch user profile from Spotify" }),
        {
          status: 502,
          headers: { "Content-Type": "application/json" },
        }
    ...
    const createRes = await spotifyFetch(
      ...
      `https://api.spotify.com/v1/users/${me.id}/playlists`,
      {
        ...
        body: JSON.stringify({
          name: generated.name,
          description:
            generated.description || "Generated by PlaylistGenius AI",
          public: false,
        }),
      }
    );
